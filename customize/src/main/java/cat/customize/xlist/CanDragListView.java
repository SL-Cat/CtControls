...
//    private int mStatusHeight = 0;
     ...
     * 默认长按事件时间是1000毫秒
     */
    private long mLongClickTime = 1500;
    /**
     * 是否可拖拽，默认为false
     */
...
//        mNewWindowLayoutParams.y = downY - mPoint2ItemTop + mOffset2Top - mStatusHeight;
        mNewWindowLayoutParams.y = downY - mPoint2ItemTop + mOffset2Top;
...
//            mNewWindowLayoutParams.y = moveY - (moveY - oldItem.getTop()) + mOffset2Top - mStatusHeight;
            mNewWindowLayoutParams.y = moveY - (moveY - oldItem.getTop()) + mOffset2Top;
