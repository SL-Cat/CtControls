...
public class SwipeRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = "CustomeSwipeRefresh";
    ...
    private boolean isCanLoadMore = false;//是否可以上拉 默认不可以
    private boolean isCanRefresh = true;//是否可以下拉 默认可以
    /**
     * 设置是否可以加载更多功能
     */
...
//        LogUtils.info("默认滑动距离："+ViewConfiguration.get(context).getScaledTouchSlop());
        mTouchSlop = 100;
